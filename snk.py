...
#represents a window objext representing the screen
s = curses.initscr()
curses.curs_set(0)
sh, sw = s.getmaxyx()
#creates a new window of the sizes given to it
#adds start point to the snake
...
key = curses.KEY_RIGHT #this is to direct our snake in a direction can be anything(variable)
